...
//                                             
    ...
    {
        SortingMethod m = static_cast<SortingMethod>(im);

        cout << endl << "Sorting tracks with " << methods[m] << " sort" << endl;
        for (int NO_OF_SONGS = 100; NO_OF_SONGS <= 5800; NO_OF_SONGS+=100)
        {
            counter = 0;
...
//             
            ...
            cout << "Slice 0-" << (NO_OF_SONGS-1) << ": " << int_to_measure(counter) << endl;

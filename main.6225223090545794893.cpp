...
int slice_iteration (int& slicenumber)
{
    for (slicenumber = 2; slicenumber < 5800; slicenumber++)
    {
        if (slicenumber % 100 == 0)
        {
            mkSlice (0, slicenumber-1);
        }
    }
    return slicenumber;
}
int main()
{
    ...
    cout << " aantal keer gedaan:" << aan << endl;

    int slicenumber =0;
    slice_iteration (slicenumber);
    cout << "De size van de input (per 100) is: " << slicenumber/100
        << " en de number of comparisons (per 100 000) is: " <<aan/100000 << endl;
	return 0;
}

...
void insert_track( vector<Track>& data , int& length, Track y )
{//               
...
void insertion_sort ( vector<Track>& data, int length )
{
	int sorted = 1 ;
    while ( sorted < length )
    {insert_track ( data, sorted, data[sorted] ) ;
    }
}
...
//       
void slice_sort(SortingMethod m)
{//            
    assert(m >= 0 && m < NoOfSortingMethods);
/*              
                                                                                                          
                                                                       
    */

    for(int i = 100; i <= 5891 ; i += 100)
    {
        //                                   
        int no_of_songs = read_tracks();
        comp_counter = 0;
        switch (m)
        {
        ...
        for(int j = 0; j < (comp_counter / 100000); j++)
            cout << "*";
        if(comp_counter % 100000 > 0)
            cout << ".";
        cout << endl;
    }
}

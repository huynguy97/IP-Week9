...
{	for ( int unsorted = 0 ; unsorted < size(data) ; unsorted++ )
	{   const int k = smallest_value_at (data, mkSlice (unsorted, size(data)-1));
...
int main()
{
    ...
    cout << "The number of comparisons: " << counter << endl;

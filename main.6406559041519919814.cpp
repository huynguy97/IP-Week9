...
{//              
    assert (0 <= a.minutes && 0 <= a.seconds) ;
/*                
...
/*                                                                       
                                                                       ...
                                                                       */
void show_comparisons(int unsorted)
{//              
    assert (0 <= unsorted) ;
/*                
                                                                    
*/
    if (unsorted == growing_limit && growing_limit < 5800) {
        int hcomparisons = comparisons;
        while (hcomparisons > 100000) {
            cout << "*";
            hcomparisons -= 100000;
        }
        if (hcomparisons < 100000 && hcomparisons != 0) {
            cout << ".";
        }
        cout << endl;
        growing_limit += 100;
...
int main()
{
    ...
    cout << "Nr. of comparisons: " << comparisons << '\n';
	return 0;
}

...
SortingMethod minimum (int a, SortingMethod b){
//              
    assert(true);
/*              
                                          
*/
        if (a < b) return static_cast<SortingMethod>(a);
        else return static_cast<SortingMethod>(b);
}

int maximum (int a, SortingMethod b){
//              
    assert(true);
/*              
...
int main()
{
    ...
    {
        case InsertionSort:{
            for(int part=100; part < NO_OF_SONGS;  part+=100){
                vector<Track> coppy;
                coppy = songs;
                count_compare=0;
                insertion_sort(coppy,part) ;
                int star_print = count_compare / 100000;
                int dot_print = count_compare % 100000;
                for(int i=0; i<star_print; i++) cout << '*';
                if(dot_print > 0) cout << '.' << endl;
            }
                break ;
        }
        case SelectionSort:{
    ...
    //                                      
    cout << "Use of < and ==: " << count_compare << endl;

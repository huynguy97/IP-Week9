...
void visualisation (vector<El>& data, int NO_OF_SONGS)
{
    int j=0, k=0, l=0;
    for (int i=0; i<NO_OF_SONGS; i+=100)
    {
        bubble_sort(data, i);
        if (counter>100000)
        {
...
void visualisation_selection (vector<El>& data, int NO_OF_SONGS)
{
    int j=0, k=0, l=0;
    for (int i=0; i<NO_OF_SONGS; i+=100)
    {
...
void visualisation_bubble (vector<El>& data, int NO_OF_SONGS)
{
    int j=0, k=0, l=0;
    for (int i=0; i<NO_OF_SONGS; i+=100)
    {

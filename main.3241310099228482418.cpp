...
int main()
{
    ...
    switch (m)
    {
        case InsertionSort: counter = 0; insertion_sort(songs,NO_OF_SONGS) ; break ;
        case SelectionSort: counter = 0; selection_sort(songs,NO_OF_SONGS) ; break ;
        case BubbleSort:    counter = 0; bubble_sort   (songs,NO_OF_SONGS) ; break ;

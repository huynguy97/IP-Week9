...
bool operator<(const Track& a, const Track& b)
{
	...
	less_than_comparisons++;
	displayamount = less_than_comparisons / 1000000;
	remainder = !(less_than_comparisons % 1000000 == 0);
...
void show_tree(int comparisons) {
	//            
	assert(true);
...
int main()
{
	...
	cout << equal_comparisons << " times equality was compared" << endl;
	cout << less_than_comparisons << " times less than was checked" << endl;

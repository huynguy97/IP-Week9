...
//	                           
void insertion_sort ( vector<Track>&  songs, int length, ofstream& outfile )
{
    counter = 0;
	int sorted = 1 ;
    while ( sorted < length )
    ...
    cout << "0-" << sliceSize << ": " << counter << "\t \t";
    outfile << "0-" << sliceSize << ": " << counter << "\t \t";
}
...
void selection_sort (vector<Track>&  songs, int length, ofstream& outfile)
{
    counter = 0;
...
void bubble_sort (vector<Track>&  songs, int length, ofstream& outfile )
{
    counter = 0;
...
void stars(int nr, ofstream& outfile){
    int starAmount = (nr - (nr%100000))/100000;
...
int main()
{
    ...
    while(sliceSize < 5800){
        bubble_sort(songs, sliceSize, outfile);
        stars(counter, outfile);

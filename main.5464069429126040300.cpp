...
bool operator<(const Track& a, const Track& b)
{
    ...
    if(a.artist<b.artist)
        return true;
    else if(a.artist==b.artist && a.cd<b.cd)
        return true;
    else if(a.artist==b.artist && a.cd==b.cd && a.year<b.year)
        return true;
    else if(a.artist==b.artist && a.cd==b.cd && a.year==b.year && a.track_no<b.track_no)
        return true;
    else
        return false;
}
...
void insertion_sort ( vector<Track>& data, int length )
{
    ...
    cout<<"There were "<<COUNTER<<" operations executed."<<endl;
}
...
int main()
{
    ...
    while(a=='y')
    {
        ...
        cout<<"."<<endl;
        cout<<"Do you want to test another sorting method?(y/n)";
        cin>>a;
    }

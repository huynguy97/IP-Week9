...
void show_comparisons(SortingMethod m)
{
    for (int i = 99; i < 5799; i = i +100)
    {
        ...
        for (int k = 0; k <= i; k++)
        {
            popsy.push_back(songs[k]);
        }
        //                        
        switch (m)
        {
            case InsertionSort: insertion_sort(popsy,i) ; break ;
            case SelectionSort: selection_sort(popsy,i) ; break ;
            case BubbleSort:    bubble_sort   (popsy,i) ; break ;
            default:        cout << "Huh?" << endl ;
        }
        //                         
        int star = counter / 100000;
        for (int v = 0; v < star; v++)
        {
            cout << "*";
        }
        if (counter%100000 != 0)
...
//     
    ...
    cout << "Sort took " << counter << " steps." << endl;

...
int size_of (vector <Track>& songs)
{
...
/*                                                                       
                                                                       ...
                                                                       */
int maximum (int choice, int NoOfSortingMethods)
{ //              
    assert (true);
  //               
  //                                           
    return max(choice, NoOfSortingMethods);
}
...
int minimum (int choice, int NoOfSortingMethods)
{
  ...
  //               
  //                                           
    return min(choice, NoOfSortingMethods);
}
...
int main()
{
    ...
    cout << counter << endl;
    //                                                                      
    int num_stars = counter/100000;
    int num_dots = counter % 1000000;

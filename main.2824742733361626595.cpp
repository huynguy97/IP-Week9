...
bool operator<(const Track& a, const Track& b)
{
    ...
    else if (a.cd < b.cd && a.artist == b.artist ){
        return  true;
    }
    else if (a.year < b.year && a.cd == b.cd && a.artist == b.artist ){
        return  true;
    }
    else if (a.track_no < b.track_no && a.year == b.year && a.cd == b.cd && a.artist == b.artist){
        return  true;
    }
    else{
        return  false;
...
int main()
{
    ...
    switch(m){
        case InsertionSort:
						...
						while (sliceMax < NO_OF_SONGS )
						{
							insertion_sort(songs, sliceMax);
							for(int x= 0; x<globcount/100000; x++ ){
								cout << '*';
							}
							if (globcount%10000 > 0){
								cout << '.';
							}
							cout << endl;
							sliceMax= sliceMax +100;
						};
						break;
        case SelectionSort:
        ...
        case BubbleSort:
						...
						while (sliceMax < NO_OF_SONGS )
						{
							bubble_sort(songs, sliceMax);
							for(int x= 0; x<globcount/100000; x++ )
							{
								cout<< '*';
							}
							if (globcount%100000 > 0)
							{
								cout << '.';
							}
							cout << endl;
    ...
    cout << "In total we made " << globcount << " comparisons.\n";

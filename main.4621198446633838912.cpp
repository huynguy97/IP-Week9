...
void display_global_counter_complexity(){
    int secglob = globcount;
    while(secglob > 100000){
        secglob = secglob - 100000;
        cout << "*";
    }
    cout << ".";
    cout << endl;
...
int main()
{
    ...
    switch (m)
    {
        case InsertionSort: insertion_sort(songs,NO_OF_SONGS); cout << "Complexity: " ; display_global_counter_complexity() ; break ;
        case SelectionSort: selection_sort(songs,NO_OF_SONGS); cout << "Complexity: " ; display_global_counter_complexity()  ; break ;
        case BubbleSort:    bubble_sort   (songs,NO_OF_SONGS); cout << "Complexity: " ; display_global_counter_complexity() ; break ;

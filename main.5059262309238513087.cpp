...
void measures()
{
    for(int i = (counter/100000); i >= 0;i-- )
    {
        cout << "*";
    }
    if(counter%100000!=0)
...
int find_position (vector<Track>& songs , Slice s, Track song )
{//	              
...
void insert (vector<Track>& songs, int& length, Track song )
{//               
...
*/
	const int POS = find_position (songs, mkSlice (0, length-1), song) ;
	if (POS < length)
...
int main()
{
    ...
    cout << "It took " << counter << " comparisons."<<endl;

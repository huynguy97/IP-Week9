...
void display_insertion(vector<Track> songs){
    int length = 99;

    while(length < 5800){
        counter = 0;

        selection_sort(songs, length) ;

        cout << counter << ": ";

        for(int i = 0; i < counter/100000; i++){
            cout << "*";
        }
...
int main()
{
    ...
    display_insertion(songs);
    cout << "Tracks sorted. Number of operations: " << counter << endl;
 //                                       
    return 0;
}

...
int find_position (vector<Track>& data, Slice s, const Track y )
{//	              
...
int main()
{
    const int NO_OF_SONGS = read_file (R"(C:\Users\Ji\Downloads\tracks.txt)");
    if (NO_OF_SONGS < 0)
    {
    ...
    cout << "Used comparison " << counter << " times" << endl;
    //                                     
    return 0;
}

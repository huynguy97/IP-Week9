...
vector<Track> songs;              //                                     
int counter;
int counterless = 0, counterequal = 0;
...
bool operator<(const Track& a, const Track& b)
{
    ...
    else if(a.cd != b.cd) {return a.cd < b.cd;}
    else if(a.year != b.year) {return a.year<b.year;}
    else if(a.time.minutes != b.time.minutes) {return a.time.minutes < b.time.minutes;}
...
bool operator==(const Track& a, const Track& b)
{
    /*                                                 */
    counterequal++;
    if ((a.artist == b.artist) && (a.cd == b.cd) && (a.year == b.year) && (a.track_no == b.track_no) && (a.time.minutes == b.time.minutes) && (a.time.seconds == b.time.seconds)) {return true;}
    else {return false;}
}
...
int main()
{
    ...
    counter = counterless+counterequal;
    cout<<"The number of comparision: "<<counter;
    cout<<" The number of counter less: "<<counterless;
    cout<<" The number of counter equal: "<<counterequal;
    cout<<endl;
    redirection();
	return 0;
}

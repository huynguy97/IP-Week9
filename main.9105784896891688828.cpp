...
//                                                                                                                   
    ...
    for(int k = 99 ; k < 5799; k+=100)
    {
        counter=0 ;
        const int NO_OF_SONGS = read_file ("Tracks.txt",songs );
        switch (m)
        {
            case InsertionSort: insertion_sort(songs,k) ; break ;
            case SelectionSort: selection_sort(songs,k) ; break ;
            case BubbleSort:    bubble_sort   (songs,k) ; break ;
